...
if [[ -f /data/models/model.t7 ]]; then
    th train.lua -input_h5 /data/processed_data/data.h5 -input_json /data/processed_data/data.json -init_from /data/models/model.t7  -gpu -1 -checkpoint_every 200 -rnn_size 512 -num_layers 3 -dropout 0.1 -checkpoint_name /tmp/checkpoint_512_3 $@
else
